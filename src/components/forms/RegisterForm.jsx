...
export default function RegisterForm(){
    return(
        <form className="flex flex-col gap-6 h-5/6 w-full px-4 pt-5 bg-white rounded-t-2xl max-w-[500px] ">
            ...
            <div className="flex flex-col gap-4">
                <Input placeholder="Nome" className="h-12 lg:h-14 border-gray-400 focus-visible:border-gray-600 focus-visible:border-2"/>
                <Input placeholder="Sobre Nome" className="h-12 lg:h-14 border-gray-400 focus-visible:border-gray-600 focus-visible:border-2"/>
                ...
                <Input placeholder="Confirmar Senha" className="h-12 lg:h-14 border-gray-400  focus-visible:border-gray-600 focus-visible:border-2"/>
            </div>
